        ...
        <div class="column">
            <form class="ui {{ $inverted }} form" method="POST" action="{{ route('backend.settings.update') }}">
                ...
                <div class="ui {{ $inverted ? 'inverted' : 'styled' }} fluid accordion">
                    ...
                    <div class="content">
                        <div class="field">
                            ...
                            <div id="mail-driver-dropdown" class="ui selection dropdown">
                                <input type="hidden" name="MAIL_MAILER">
                                <i class="dropdown icon"></i>
                                <div class="default text"></div>
                                <div class="menu">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="MAIL_PORT" value="{{ config('mail.mailers.smtp.port') }}">
                        </div>
                        <div class="field">
                    ...
                    <div class="content">
                        <div class="field">
                            <label>{{ __('settings.coincap_api_key') }}</label>
                            <input type="text" name="COINCAP_API_KEY" value="{{ config('settings.coincap_api_key') }}" placeholder="3br583e8-608b-40f6-b56e-f0aa58t8881">
                        </div>
                        <div class="field">
...
@push('scripts')
    <script>
        ...
        $('#mail-driver-dropdown').dropdown('set selected', '{{ config('mail.default') }}');
        $('#mail-encryption-dropdown').dropdown('set selected', '{{ config('mail.mailers.smtp.encryption') }}');
        ...
        $('#assets-api-type-dropdown').dropdown('set selected', '{{ config('settings.assets_quotes_api') }}');
    </script>
@endpush
