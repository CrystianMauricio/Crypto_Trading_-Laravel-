                ...
                <div class="ui one column grid">
                    ...
                    <div class="center aligned column">
                        <template v-if="selectedAsset.symbol">
                            <asset-chart :asset="selectedAsset" color="{{ $settings->color }}" :currency="{{ json_encode(['code' => config('settings.currency'), 'rate' => $currency_rate]) }}" api-key="{{ config('settings.coincap_api_key') }}" :inverted="{{ $inverted ? 'false' : 'true' }}"></asset-chart>
                        </template>
                    </div>
                    <div class="center aligned column">
                        <template v-if="selectedAsset.symbol">
