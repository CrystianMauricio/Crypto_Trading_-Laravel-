                                ...
                                <div class="event">
                                    <div class="label">
                                        <div class="tooltip" data-tooltip="<?php echo e($recent_trade->asset->name); ?>" <?php echo e($inverted ? 'data-inverted="false"' : ''); ?>>
                                            <img src="<?php echo e($recent_trade->asset->logo_url); ?>">
                                        </div>
                                    </div>
                                    <div class="content">
                                        <div class="date">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\my project\Laravel_chat_task\codecanyon-uRdMItwk-crypto-trading-competitions (1)\resources\views/pages/frontend/users/show.blade.php ENDPATH**/ ?>