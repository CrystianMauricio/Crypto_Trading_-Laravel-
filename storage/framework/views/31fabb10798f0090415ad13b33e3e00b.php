...
<!--END Open Graph tags-->
<?php echo $__env->renderWhen(config('settings.gtm_container_id'), 'includes.frontend.gtm-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
<?php echo $__env->make('includes.frontend.styles', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\my project\Laravel_chat_task\codecanyon-uRdMItwk-crypto-trading-competitions (1)\resources\views/includes/frontend/head.blade.php ENDPATH**/ ?>