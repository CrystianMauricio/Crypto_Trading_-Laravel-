...
if (version_compare(phpversion(), '8.1', '<')) {
    $errors[] = sprintf('PHP <b>8.1</b> or higher should be installed (currently installed PHP %s).', phpversion());
}
...
<body>
    <div class="ui basic segment">
        <div class="ui one column stackable grid container">
            <div class="column">
                <h1 class="ui teal dividing header">Installation</h1>
            </div>
            <div class="column">
                <h2 class="ui teal header"><i class="cogs icon"></i> System requirements</h2>
